        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-auto">
                <ul class="ps-0 mb-0 d-flex label-white" style={{ listStylePosition: 'inside'}}>
                    <li class="me-4">
                        <Link to="/term-conditions" class="text-decoration-none fs-16 fw-700 lh-34 label-white">Terms
                            & Conditions</Link>
                    </li>
                    <li class="me-4">
                        <Link to="/privacy-policy"
                            class="text-decoration-none fs-16 fw-700 lh-34 label-white">Privacy Policies </Link>
                    </li>
                    <li class="me-4">
