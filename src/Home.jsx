...
import MobilePageScroller from './MobilePageScroller';
import CustomPageScroller from './MobilePageScroller';
...
export default function Home() {
    ...
    return (
        <>
            ...
            <CustomPageScroller headerOffset={68} animationDuration={700}>
